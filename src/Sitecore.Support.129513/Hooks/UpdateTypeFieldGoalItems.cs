			...
			using (new SecurityDisabler())
			{
				...
				*/
				...
				string[] itemPaths = new string[]
				{
										...
										"/sitecore/system/Settings/Rules/Definitions/Elements/Visit/Outcome was registered during a past or current interaction",
										"/sitecore/system/Settings/Rules/Definitions/Elements/Visit/Outcome with custom data was registered during a past or current interaction",
				...
				Type[] types = new Type[]
				{
										...
										typeof(Sitecore.Support.Analytics.Rules.Conditions.CampaignWasTriggeredDuringPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.CampaignWithCustomDataWasTriggeredDuringPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.ChannelOfPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.PageEventWasTriggeredDuringPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.PageEventWithCustomDataWasTriggeredDuringPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.VenueOfPastOrCurrentInteractionCondition<>),
										typeof(Sitecore.Support.Analytics.Rules.Conditions.VenueWithCustomDataOfPastOrCurrentInteractionCondition<>),
				};
